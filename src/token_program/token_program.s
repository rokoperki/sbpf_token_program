...
set_authority:
    ...
    ldxdw r8, [r10 - 16]                             ; r8 = acct1 (authority)
    ...
    ;copy ix_data.authority -> token.authority
    mov64 r1, r6
    add64 r1, ACCT_DATA
    add64 r1, TA_AUTHORITY
    mov64 r2, r7
...
close_account:
    ...
    jne r3, 1, err_invalid_ix                       ;check ix data len
    ...
    ;balance == 0
    ldxdw r4, [r6 + ACCT_DATA + TA_BALANCE]
    jne r4, 0, err_nonzero_balance
    mov64 r0, 0

    stxdw [r6 + ACCT_DATA +  0], r0
    stxdw [r6 + ACCT_DATA +  8], r0
    stxdw [r6 + ACCT_DATA +  16], r0
    stxdw [r6 + ACCT_DATA +  24], r0
    stxdw [r6 + ACCT_DATA +  32], r0
    stxdw [r6 + ACCT_DATA +  40], r0
    stxdw [r6 + ACCT_DATA +  48], r0
    stxdw [r6 + ACCT_DATA +  56], r0
    stxdw [r6 + ACCT_DATA +  64], r0
